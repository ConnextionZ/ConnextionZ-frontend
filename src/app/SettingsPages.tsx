...
//
// One component per row in the Settings list. Every row in `SettingsScreen`
// resolves to exactly one `SettingsRoute` here, so no menu option is a dead end.
//
// Two save models are used deliberately:
